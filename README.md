...
3. Use "Themes -> Add New" and then upload the latest ZIP file. (Note: If you are using WordPress Multisite you will then need to do "Network Enable".)
